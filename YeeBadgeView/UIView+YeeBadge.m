...
- (void)setRedDotBorderWith:(CGFloat)redDotBorderWith {
    ...
    [self _yeeBadgeView].redDotBorderWith = redDotBorderWith;
}
- (CGFloat)redDotBorderWith {
    return [self _yeeBadgeView].redDotBorderWith;
}
...
- (void)setRedDotBoderColor:(UIColor *)redDotBoderColor {
    ...
    [self _yeeBadgeView].redDotBoderColor = redDotBoderColor;
}
- (UIColor *)redDotBoderColor {
    return [self _yeeBadgeView].redDotBoderColor;
}
